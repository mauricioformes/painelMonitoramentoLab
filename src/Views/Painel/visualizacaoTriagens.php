			...
			<div class="card mb-5 mb-xl-8">
				...
				<div class="card-body py-3">
					...
					<div class="table-responsive">
						<!--begin::Table-->
						<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" style="tr:nth-child(even)" id="tabelaTriagens">
							<!--begin::Table head-->
							<thead>
								<tr class="fw-bolder text-muted">
									...
									<th class="min-w-120px" style="text-align: center">Data Coleta</th>
...
<script>
	$(document).ready(function() {
		const tableTriagens = $("#tabelaTriagens").dataTable({
		...
		const totalRowsTriagens = tableTriagens.fnGetData().length;
		const qtdPaginasTriagens = totalRowsTriagens / 10;

		var paginaTriagens = 0;

		setInterval(function() {
			//var qtdPaginasTriagens = totalRowsTriagens / 10;

			//console.log(totalRowsTriagens);
			if (qtdPaginasTriagens > 1) {
				tableTriagens.fnPageChange(paginaTriagens++);
			}
			if (paginaTriagens == qtdPaginasTriagens) {
				paginaTriagens = 0;
			}
