...
//var_dump(formatarTempoCompleto($data['coletas'][0]['DEFLATOR']));



?>
<h3 class="page-title">
    Painel <small>/ Assinaturas</small>
</h3>
...
<div>
    ...
    <div class="contentpanel">
        <div class="panel panel-default">
            <br>
            <form name='form_assinaturas' id="form_assinaturas" action='#' class="form-horizontal" method='GET'>
                <div class=" form-group" id="linha_processo">
                    ...
                    <div class="col-md-2 col-sm-2 text-center ">
                        <button type='button' name='pesquisarAssinaturas' id="pesquisarAssinaturas" class='btn btn-primary' value='Comunicar'><i class="glyphicon glyphicon-search"></i>Pesquisar</button>
                    </div>
                    <div class="col-md-2 col-sm-2 text-center">
                    <a class='btn btn-primary' id="dashboardAssinatura" target="_blank"><i class="glyphicon glyphicon-plus"></i>Dashboard TV</a>
                    </div>
                </div>
            </form>
            <br>
    ...
    <div class="portlet" id="exibeTabelaAssinatura" hidden>
