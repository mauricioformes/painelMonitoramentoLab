...
<div id="resultado-teste" name="resultado-teste">
    ...
    <div class="contentpanel">
        <div class="panel panel-default">
            <br>
            <form name='form_coletas' id="form_coletas" action='#' class="form-horizontal" method='GET'>
                <div class=" form-group" id="linha_processo">
                    ...
                    <div class="col-md-2 col-sm-2 text-center ">
                        <button type='button' name='pesquisarColetas' id="pesquisarColetas" class='btn btn-primary' value='Comunicar'><i class="glyphicon glyphicon-search"></i>Pesquisar</button>

                    </div>

                    <div class="col-md-2 col-sm-2 text-center ">
                    <a class='btn btn-primary' id="dashboardColeta" target="_blank"><i class="glyphicon glyphicon-plus"></i>Dashboard TV</a>
                    </div>
                </div>
            </form>
            <br>
    ...
    <div class="portlet" id="exibeTabelaColeta" hidden>
        ...
        <div class="portlet-body" style="display: block;">
            <div class="contentpanel">
                <div class="panel panel-default">
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table" style="margin-top:1%; width: 100%; height: 100%; border: 1px solid;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:center">Data Coleta</th>
                    ...
                    <!-- <div class="row">
                                    <div class="col-md-6">
                                        <h4 style="margin-left: 5%;"><b>Nenhum paciente encontrado.</b></h4>
                                    </div>
                                </div> -->
