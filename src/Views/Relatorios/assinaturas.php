...
?>
<h3 class="page-title">
    Relatórios <small>/ Assinaturas</small>
</h3>
...
<div id="resultado-teste" name="resultado-teste">
    ...
    <div class="contentpanel">
        <div class="panel panel-default">
            <br>
            <form name='form_relatorio_assinaturas' id="form_relatorio_assinaturas" action='assinaturas' class="form-horizontal" method='GET'>
                <div class=" form-group" id="linha_processo">
                    ...
                    <div class="col-md-2 col-sm-2 text-center ">
                        <button type='submit' name='pesquisarRelatorioAssinaturas' id="pesquisarRelatorioAssinaturas" class='btn btn-primary' value='Comunicar'><i class="glyphicon glyphicon-search"></i>Pesquisar</button>
                        <button type="button" class="btn btn-primary" id="btnGerarExcelAssinaturas"><i class="glyphicon glyphicon-plus"></i>
                            Excel
                        </button>
                    </div>
                </div>
                            ...
                            <table class="table parametrizacao table-bordered table-striped table-dark">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center">Data Liberou Assinatura</th>
                                        <th style="text-align: center">Data Assinou</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center"><?php echo $exames["DATA_LIBEROU_ASSINATURA"]; ?></td>
                                                <td style="text-align:center"><?php echo $exames["DATA_ASSINOU"]; ?></td>
...
<div id="tableAssinaturas" style="display:none;">
